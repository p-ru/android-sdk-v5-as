...
class CommonFragmentPageInfoFactory : IFragmentPageInfoFactory {
    ...
    override fun createPageInfo(): FragmentPageItemList {
        return FragmentPageItemList(R.navigation.nav_common).apply {
            ...
            //feb 4, testing the camera stream detail
            items.add(FragmentPageItem(R.id.key_camera_stream_detail_page, R.string.item_multi_video_decoding_title, R.string.item_multi_video_decoding_description, true))
